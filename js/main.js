...
let employees = [
    {id: employeeId++, name: `Jeffery`, age: 35, hours: 50, payRate: 25},
    {id: employeeId++, name: `Alyson`, age: 29, hours: 43, payRate: 18},
    {id: employeeId++, name: `Thomas`, age: 42, hours: 37, payRate: 32}
];
...
function calculateAnnualSalary(hours, payRate, Type) {
    let salary = 0;
...
function displayEmployees() {
    ...
    employees.forEach((employee) => {
        ...
        const salary = calculateAnnualSalary(employee.hours, employee.payRate, type);
...
addEmployeeForm.addEventListener(`submit`, function(e) {
    ...
    if (!name || isNaN(age) || isNaN(hours) || isNaN(payRate)) {
